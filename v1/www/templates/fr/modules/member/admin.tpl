 ...
 <if cond='is_array(|{mbr_array}|)'>
  ...
  <tr>
   ...
   <td>
    ...
    <a href="index.php?file=admin&amp;module=member&amp;act=view&amp;mid={result[mbr_mid]}" title="Infos sur {result[mbr_pseudo]}">{result[mbr_pseudo]}</a></td>
...
<elseif cond='|{mbr_act}| == "view"'>
 ...
 <if cond='{al_array[al_name]}'>
	 Alliance: <a href="index.php?file=admin&amp;act=view&amp;module=alliances&amp;al_aid={al_array[al_aid]}" title="Infos sur {al_array[al_name]}">{al_array[al_name]}</a><br/>
 </if>
...
<elseif cond='|{mbr_act}| == "edit"'>
  ...
  <else>
  	<form method="post" action="index.php?file=admin&amp;module=member&amp;act=edit&amp;sub=edit&amp;mid={mbr_mid}">
	   ...
	   Login : <input type="text" name="login" value="{mbr_login}" /><br/>
	   Pseudo : <input type="text" name="pseudo" value="{mbr_pseudo}" /><br/>
	...
	<form method="post" action="index.php?file=admin&amp;module=member&amp;act=edit&amp;sub=add_rec&amp;mid={mbr_mid}">
	...
	<if cond="is_array(|{rec_array}|)">
	<form method="post" action="index.php?file=admin&amp;module=member&amp;act=edit&amp;sub=del_rec&amp;mid={mbr_mid}">
		<select name="rec_id" id="rec_id">
			<foreach cond="|{rec_array}| as |{rec_value}|">
				<option value="{rec_value[rec_id]}">{recompense[{rec_value[rec_type]}]}</option>
			</foreach>
		</select>
