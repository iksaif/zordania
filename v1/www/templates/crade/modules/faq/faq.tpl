...
<dl>
  ...
  <dt id="vacs">Je pars en vacances, est-ce possible de mettre mon compte en veille?</dt>
    ...
    <dd>Oui, un bouton "mise en veille" est prévu pour cela, il permet ainsi de ne pas se faire attaquer mais aussi de ne pas amasser de ressources.
	    La mise en veille marche pour une durée minimale de <strong>10 jours </strong></dd>
  ...
  <dt id="cookies">Sur le site est affiché:"Il faut activer les cookies pour pouvoir profiter du site !" mais je ne sais pas comment faire</dt>
    ...
    <dd>
    Il faut accepter tout les cookies provenant de zordania.cliranet.com<br />
	    <dl>
	    <dt>Pour IE:</dt>
  ...
  <dt id="points">Comment sont calculés les points?</dt>
    ...
    <dd>les points se calculent ainsi: Nombre d'unités d'or x 2 + Nombre de Bâtiments x 20 + Nombre d'unités x 5 + Nombre de Recherches x 250 + Experience de vos Legions x 20</dd>
	
  <dt id="distance">Comment je calcule le temps que je met suivent X distance?</dt>
  
    <dd>la nombre de tours totals est égal à la distance divisé par la vitesse (la vitesse est celle de l'unité la plus lente). c'est arrondi au supérieur.<br />
	    ex: j'attaque un ennemi situé à 35 de distance avec 3 miliciens et 2 fantassins (la vitesse la plus lente est celle du fantassin, cad 5)</br>
		    35/5=7 (je mettrais donc 7 tours à l'attaquer)</dd>

  <dt id="exp">A quoi sert l'expérience?</dt>
  
    <dd>l'expérience sert à augmenter ses <a href="faq.html#points">points</a>, et à apparaitre au top 50 :#)</dd>
