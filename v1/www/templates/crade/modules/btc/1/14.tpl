...
<a href="index.php?file=btc&amp;act=use&amp;btc_type={btc_id}&amp;sub=unt">Construire</a> 
]-[
...
<elseif cond='|{btc_act}| == "cancel_unt"'>
	...
	<elseif cond='|{btc_no_nb}| == true'>
		<p class="infos">Il faut choisir un nombre d'unités à annuler.</p>
 		<form action="index.php?file=btc&amp;act=use&amp;btc_type=14&amp;sub=cancel_unt&amp;uid={btc_uid}" method="post">
...
<elseif cond='|{btc_act}| == "unt"'>
	<div class="center">Recrues disponibles: {unt_in_db[1][7][unt_nb]} <img src="img/{session_user[race]}/unt/7.png" alt="{unt[alt][7]}" title="{unt[alt][7]}" /></div><br />
	    ...
	    <td>
 		...
 		<if cond='is_array(|{unt_array[vars][prix]}|)'>
 		 ...
 		 <if cond='is_array(|{unt_array[vars][needguy]}|)'>
  		 ...
  		 <form action="index.php?file=btc&amp;act=use&amp;btc_type=14&amp;sub=add_unt" method="post">
...
<elseif cond='|{btc_act}| == "add_unt"'>
	...
	<elseif cond='|{btc_no_nb}| == true'>
	<p class="error">Il faut choisir un nombre d'unités à constuire.</p>
	</elseif>	
	...
	<p class="error">Pas assez de ressources, de place (maisons) ou nombre maximal d'unité atteint ({max_unt_nb}).</p>
	</elseif>
	<elseif cond='|{btc_ok}| == true'>
	<p class="ok">Unité(s) en construction !</p>
	</elseif>
	<elseif cond='|{btc_error}| == true'>
