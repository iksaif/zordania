 ...
 <td>
  ...
  <if cond='is_array(|{res_array_fini}|)'>
   ...
   <foreach cond='|{res_array_fini}| as |{res_type}| => |{res_array}|'>
      <tr>
   	<td><img src="img/{mbr_array[mbr_race]}/res/{res_type}.png" title="{unt_type}" alt="{res_type}" /></td>
 ...
 <td>
  ...
  <if cond='is_array(|{unt_array_fini[0]}|)'>
   ...
   <foreach cond='|{unt_array_fini[0]}| as |{unt_type}| => |{unt_array}|'>
      <tr>
   	<td><img src="img/{mbr_array[mbr_race]}/unt/{unt_type}.png" title="{unt_type}" alt="{unt_type}" /></td>
 ...
 <td>
  ...
  <if cond='is_array(|{src_array_fini}|)'>
   ...
   <foreach cond='|{src_array_fini}| as |{src_type}| => |{src_array}|'>
      <tr>
   	<td><img src="img/{mbr_array[mbr_race]}/src/{src_type}.png" title="{src_type}" alt="{src_type}" /></td>
      </tr>
   </foreach>
   </table>
  </if>
 ...
 <td>
  ...
  <if cond='is_array(|{btc_array_fini}|)'>
   ...
   <foreach cond='|{btc_array_fini}| as |{btc_type}| => |{btc_array}|'>
      <tr>
   	<td><img src="img/{mbr_array[mbr_race]}/btc/{btc_type}.png" title="{btc_type}" alt="{btc_type}" /></td>
