...
<!DOCTYPE membre SYSTEM "{cfg_url}templates_xml/fr/modules/member/member.dtd">
<if cond='!|{bad_mid}|'>
<?xml-stylesheet type="text/xsl" href="{cfg_url}templates_xml/fr/modules/member/member.xsl"?>
...
<membre>
	...
	<ressource>
		...
		<res_nom>{res[{mbr_array[mbr_race]}][alt][{res_vars[res_type]}]}</res_nom>
