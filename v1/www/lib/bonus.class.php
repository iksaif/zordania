...
class bonus
{
	...
	function get_log()
	{
		$req = "SELECT mbr_pseudo,mbr_race,bon_mid,bon_code,bon_ok,bon_res_type,bon_res_nb,formatdate(bon_date) as bon_date,formatdate(bon_date) as bon_date_formated ";
