			...
			<body>
				...
				<div class="population">
					...
					<xsl:element name="img">
							<xsl:attribute name="src">img/<xsl:value-of select="membre/race/race_rid" />/<xsl:value-of select="membre/race/race_rid" />.png</xsl:attribute>
				...
				<div class="position">Position <xsl:value-of select="membre/position/x" />x<xsl:value-of select="membre/position/y" /></div>
			</body>
